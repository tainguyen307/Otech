export default function Logo({ onClick }) {
  const content = <><img src="/icon.svg" alt="" aria-hidden="true" className="h-9 w-9 rounded-xl object-cover" /><span className="text-xl font-black tracking-[-0.05em] text-[#172238] dark:text-white">otech<span className="text-[#087cf5]">.</span></span></>
